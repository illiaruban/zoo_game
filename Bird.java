public class Bird extends Animal{
                ...
                float visitPrice, boolean carnivore, int amountInArea)
    {
        ...
        amountOfFeedings = 3;
        this.type = Animal.typeAnimal.Bird;
    }
    //copy
    public Bird(Bird object)
    {
        super(object);
        this.carnivore = object.carnivore;
    }
    ...
    {
        String text = name + ", Bird, "+ id + ", " + price + ", " + visitPrice + ", " + maxVisitPrice + ", " + this.amountInArea + ", " + maxAmountInArea + ", ";
        if (this.carnivore)
        {
            text += "1";
        }
