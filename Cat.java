public class Cat extends Animal{
               ...
               float visitPrice, boolean aggressive, int amountInArea)
    {
        ...
        this.type = Animal.typeAnimal.Cat;
        notFedTwoDays = 0;
    }
    //copy
    ...
    {
        super(object);
        this.aggressive = object.aggressive;
    }
    ...
    {
        String text = name + ", Cat, " + id + ", "+ price + ", " + visitPrice + ", " + maxVisitPrice + ", " + this.amountInArea + ", " + maxAmountInArea  + ", ";
        if (this.aggressive)
        {
            text += "1";
        }
